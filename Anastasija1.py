...
You are insde a dark cave.
You hear a waterfall nearby""")

waterfall= cave.east= a.Room("""
You are infornt of a waterfall!
You see a secret entrance.
Enter the room""")

secret_entrance=waterfall.south= a.Room("""
You are in a secret room.
There is a plane!
Board the plane!""")

plane = secret_entrance.west= a.Room("""
You are in the plane
You fly to NYC""")

nyc = plane.south = a.Room("""
You are in NYC
Go south""")

fifth_avenue= nyc.south = a.Room("""
You are on the fifth avenue.""")
...
book= a.Item("book")
magic_forest.items= a.Bag({book})

bear=a.Item("bear")
cave.items=a.Bag({bear})

meal=a.Item("meal")
plane.items=a.Bag({meal})
